...
当你的 advancement JSON 使用 `"trigger": "minecraft:impossible"` 时，需要用 Java 辅助检测。以下 5 种类型可直接选用：
  ...
  "milestones": [
    {
      ...
      "advancement": "adventure_power:survive_first_night",
      "trigger": { "type": "survive_night" }
    },
    {
      "id": "enter_nether",
  ...
  "milestones": [
    {
      ...
      "advancement": "adventure_power:welcome",
      "trigger": { "type": "survive_night" }
    },
    {
      "id": "slay_wither",
      ...
      "advancement": "adventure_power:slay_wither",
      "trigger": { "type": "first_kill", "entity": "minecraft:wither" }
    },
    {
      "id": "slay_dragon",
    ...
    },
    {
      ...
      "advancement": "adventure_power:slay_warden",
...
```json
{
  "milestones": [
    { "id": "m1", "name": "初夜", "abilities": ["agility"],
      "advancement": "adventure_power:m1", "trigger": {"type":"survive_night"} },
    { "id": "m2", "name": "初死", "abilities": ["perpetual_blessing"],
      "advancement": "adventure_power:m2", "trigger": {"type":"first_death"} },
    ...
    { "id": "m7", "name": "交易", "abilities": ["extended_reach"],
      "advancement": "adventure_power:m7", "trigger": {"type":"first_trade"} },
    { "id": "m8", "name": "地下", "abilities": ["undying_gear"],
      "advancement": "adventure_power:m8", "trigger": {"type":"y_below","y":0} },
    ...
    { "id": "m11", "name": "凋零", "abilities": ["lifesteal","healing_block"],
      "advancement": "adventure_power:m11", "trigger": {"type":"first_kill","entity":"minecraft:wither"} },
    { "id": "m12", "name": "监守", "abilities": ["vitality","resilience"],
      "advancement": "adventure_power:m12", "trigger": {"type":"first_kill","entity":"minecraft:warden"} },
...
2. 如果使用 `trigger`，配套的 advancement JSON 是否已创建且 `trigger: "minecraft:impossible"`
