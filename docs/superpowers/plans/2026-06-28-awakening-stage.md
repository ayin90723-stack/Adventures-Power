...
**Files:**
- Modify: `src/main/java/com/rosycentury/adventure_power/skill/ActiveSkillHandler.java`
...
```bash
git add src/main/java/com/rosycentury/adventure_power/skill/ActiveSkillHandler.java
...
```java
            ...
            if (progress.isFullyUnlocked() && progress.isAbilityEnabled("active_skill")) {
                com.rosycentury.adventure_power.skill.ActiveSkillHandler.executeJudgment(
...
**Files:**
- Modify: `src/main/java/com/rosycentury/adventure_power/input/DoubleJumpHandler.java`
...
```bash
git add src/main/java/com/rosycentury/adventure_power/input/DoubleJumpHandler.java
...
**Files:**
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/PlayerStateHandler.java`
...
```bash
git add src/main/java/com/rosycentury/adventure_power/handler/PlayerStateHandler.java
...
**Files:**
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/CombatAbilityHandler.java`
...
```bash
git add src/main/java/com/rosycentury/adventure_power/handler/CombatAbilityHandler.java
...
**Files:**
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/RecoveryHandler.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/CombatAbilityHandler.java`
...
```bash
git add src/main/java/com/rosycentury/adventure_power/handler/RecoveryHandler.java src/main/java/com/rosycentury/adventure_power/handler/CombatAbilityHandler.java
...
**Files:**
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/ExplorationAbilityHandler.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/RecoveryHandler.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/KnockbackResistHandler.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/FortuneFavorHandler.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/handler/PlayerStateHandler.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/mixin/SeeAndSlashMixin.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/mixin/TrueHealthMixin.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/mixin/RejectHealthManipMixin.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/ability/ResilienceAbility.java`
- Modify: `src/main/java/com/rosycentury/adventure_power/ability/FortuneFavorAbility.java`
...
```bash
git add src/main/java/com/rosycentury/adventure_power/handler/ && git add src/main/java/com/rosycentury/adventure_power/mixin/ && git add src/main/java/com/rosycentury/adventure_power/ability/ && git add src/main/java/com/rosycentury/adventure_power/util/FortuneContext.java && git add src/main/java/com/rosycentury/adventure_power/capability/AdventureProgressCapability.java
